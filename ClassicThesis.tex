...
\ifdraft{\includepdf[pages=-]{papers/Braemer2022-Pairlocalization.pdf}}
\addtocounter{page}{0} % add space to account for inserted paper -> insert will be done via an external tool
\include{Chapters/Chapter06}
\ifdraft{\includepdf[pages=-]{papers/Franz2022-Cusp.pdf}}
\addtocounter{page}{0}
\include{Chapters/Chapter07}
\ifdraft{\includepdf[pages=-]{papers/Franz2023-UniversalDynamics.pdf}}
\addtocounter{page}{0}
\include{Chapters/Chapter08}
\ifdraft{\includepdf[pages=-]{papers/Euler2024-MetronomeSpin.pdf}}
\addtocounter{page}{0}
