...
\nocite{braemerPairLocalizationDipolar2022, franzObservationUniversalRelaxation2023, franzEmergentPairLocalization2022} % is local to to the enclosing refsection
\printbibliography[heading=none, keyword={thesis-main}]
The author also contributed to the following publications:

\nocite{eulerMetronomeSpinStabilizes2024, geierTimereversalDipolarQuantum} 
